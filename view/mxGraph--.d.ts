 ...
 */
imageBundles: Array<mxRectangle>;
 ...
 */
getCurrentCellStyle(cell: mxCell, ignoreState?: boolean) {
 ...
 * the edge is used.
 */
splitEdge(edge, cells, newEdge, dx, dy, x, y, parent): mxCell {
dx = dx || 0;
dy = dy || 0;
  ...
  if (this.dialect == mxConstants.DIALECT_SVG) {
    ...
    if (dx == 0 && dy == 0) {
      ...
      if (this.shiftPreview1 == null) {
        ...
        this.shiftPreview1.style.position: string;
        this.shiftPreview1.style.overflow: string;
